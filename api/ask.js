...
<body>
    ...
    <div id="ai-panel">
      ...
      <div id="ai-body">
        ...
        <div id="ai-tools">
            ...
            <button class="magic-btn" onclick="magicSpawn()">✨ Auto-Classify & Spawn</button>
            
            <div id="chat-inputs">
              <button onclick="askAI('tip')">💡 Tip</button>
              <button onclick="analyzeCity()">📊 Analyze</button>
              <button class="action-btn" onclick="generateChaos()">⚠️ Task Storm (AI)</button>
            </div>
        </div>
  ...
  <script>
    ...
    async function askAI(mode) {
        ...
        } catch(e) { addChatMsg("AI Offline.", "bot"); }
    }
        ...
        try {
            ...
            if(data.reply) {
                ...
                if(['work','personal','urgent'].includes(type)) {
                    ...
                    addChatMsg(`✅ AI Classified "${text}" as ${type.toUpperCase()}`, "bot");
                } else {
                    addChatMsg(`❓ Could not classify "${text}". Try again.`, "bot");
                }
            }
        } catch(e) {
    ...
    async function generateChaos() {
        ...
        try {
            ...
            if(data.reply) {
                ...
                addChatMsg(`⚠️ INCOMING STORM: ${count} TASKS!`, "bot");
            }
        } catch(e) { addChatMsg("Storm failed.", "bot"); }
    }
